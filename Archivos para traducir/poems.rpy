...
# El 'n\' significa salto de linea, por lo que se debe mantener en la traducción.
...
translate spanish strings:
    ...
    ### poem_m21 | se llama igual, "Hole in Wall", solo que no aparece doble sino crearia un conflicto
    # game/poems.rpy:448
    ...
    ### poem_m22 | Igual se llama Save Me
    # game/poems.rpy:494
